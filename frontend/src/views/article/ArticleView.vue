			...
			<div class="main__article__comments">
				...
				<div class="main__article__comments__newComment">
					...
					<div class="main__article__comments__newComment__reactions">
						<p @click="onLikeReaction()" class="main__article__comments__newComment__reactions__like" :class="currentCommentReaction == 1 ? 'selected' : ''">{{ langData['reactionLikeTitle'] }}</p>
						<p class="main__article__comments__newComment__reactions__delimiter">/</p> 
						<p @click="onDislikeReaction()" class="main__article__comments__newComment__reactions__dislike" :class="currentCommentReaction == 2 ? 'selected' : ''">{{ langData['reactionDislikeTitle'] }}</p>
					</div>
