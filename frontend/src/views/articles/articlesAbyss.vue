<script setup lang="ts">
    ...
    import langsData from "./locales/articlesAbyss.json";
    import { LangDataHandler } from "./../../ts/LangDataHandler";

    import './../../libs/font_2605852_prouiefeic';

	const langData = LangDataHandler.initLangDataHandler("articlesAbyss", langsData).langData;
    ...
    //TODO Replace time in article to timestamp
    // Articles
    const articles = ref([
        {
            title: "Test Abyss Article",
        ...
        },
        {
            ...
            currentVersionText: "# Test Abyss Article 2\n## 🤗 Code\n\n```vue\n<template>\n  <MdEditor v-model=\"text\" />\n</template>\n\n\<script setup\>\nimport { ref } from 'vue';\nimport { MdEditor } from 'md-editor-v3';\nimport 'md-editor-v3/lib/style.css';\n\nconst text = ref('Hello Editor!');\n\</script\>\n```"
        },
        {
            title: "Test Abyss Article 3",
            ...
            currentVersionText: "# Test Abyss Article 3 \n 🖨 Text\n\nThe Old Man and the Sea served to reinvigorate Hemingway's literary reputation and prompted a reexamination of his entire body of work.\n\n## 📈 Table\n\n| nickname | from             |\n| -------- | ---------------- |\n| zhijian  | ChongQing, China |\n\n## 📏 Formula\n\nInline: $x+y^{2x}$\n\n$$\n\\sqrt[3]{x}\n$$\n\n## 🧬 Diagram\n\n```mermaid\nflowchart TD\n  Start --> Stop\n```\n\n## 🪄 Alert\n\n!!! note Supported Types\n\nnote、abstract、info、tip、success、question、warning、failure、danger、bug、example、quote、hint、caution、error、attention\n\n!!!\n\n## ☘️ em..."
        },
        {
            title: "Test Abyss Article 4",
            ...
            currentVersionIdIndex: 7,
            currentVersionText: "# Test Abyss Article 4 \n ![Picture](https://imzbf.github.io/md-editor-rt/imgs/mark_emoji.gif)"
        }
    ]);
...
<style lang="scss" scoped src="./scss/articlesAbyss.scss"></style>