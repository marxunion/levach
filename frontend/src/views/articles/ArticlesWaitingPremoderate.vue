<script setup lang="ts">
    ...
    import { Article, articleReloading, articles } from '../../ts/handlers/ArticlesHandler';
	...
	const langData = LangDataHandler.initLangDataHandler("ArticlesWaitingPremoderate", langsData).langData;
...
<template>
    <main class="main">
        <div class="main__header">
			<p class="main__header__title">{{ (langData['headerTitle'] as JsonData)['ArticlesWaitingPremoderate'] }}</p>
