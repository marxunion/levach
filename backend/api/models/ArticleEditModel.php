...
class ArticleEditModel extends BaseModel
{
    ...
    public function editArticle($articleId, $newTitle, $newText, $newTags, $cookiesBody)
    {
        ...
        if(isset($statisticsData))
        {
            ...
            {
                if($statisticsData['edit_timeout_to_date'] < time() || AdminStatusHandler::isAdmin($cookiesBody))
                {
