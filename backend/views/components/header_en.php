<header class="header lock_padding">
  ...
  <div class="header__bar">
    <div class="header__bar__search">
      <input placeholder="Search..." type="text" class="header__bar__search__input">
      <a href="/" class="header__bar__search__button"></a>
    </div>
    <div class="header__bar__subbar">
      <a href="/createarticle/en" class="header__bar__subbar__createarticle"><p>Create article</p></a>
      <div class="header__bar__subbar__select custom-select">
        ...
        >
          <span class="header__bar__subbar__select__value selected-value">EN</span>
      ...
      <a class="header__bar__subbar__createarticlemobile">
